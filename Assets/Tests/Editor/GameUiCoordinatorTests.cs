...
public class GameUiCoordinatorTests
{
    ...
    public void Constructor_NullStateMachine_ThrowsArgumentNullException()
    {
        Assert.Throws<ArgumentNullException>(() =>
            new GameUiCoordinator(null, baseStore, null, null, null));
    }
    ...
    {
        Assert.Throws<ArgumentNullException>(() =>
            new GameUiCoordinator(stateMachine, null, null, null, null));
    }

    [Test]
    public void Teardown_CalledTwice_NoException()
    {
        var coordinator = new GameUiCoordinator(stateMachine, baseStore, null, null, null);
